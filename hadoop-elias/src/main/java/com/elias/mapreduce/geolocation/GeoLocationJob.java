...
public class GeoLocationJob {
        ...
        public static void main(String[] args) throws Exception {
            ...
            if (otherArgs.length != 2) {
                System.err.println("Usage: com.elias.mapreduce.geolocation.GeoLocationJob <in> <out>");
                System.exit(2);
            }
            
            Job job = new Job(conf, "geolocation job");

            job.setJarByClass(GeoLocationJob.class);
